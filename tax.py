...
def main():
    ...
    total_input = input("Please input the base month income, and the rating money with space split and tax special discard money, such as 12000 12000 2000: ")
    input_list = total_input.split(' ')
    total_income = input_list[0]
    rating_money = input_list[1]

    tax_special_discard_money = input_list[2]
    ...
    tax_money = TaxRating.calculateTax(personal_income_with_tax, (float)(tax_special_discard_money))
    personal_income_without_tax = personal_income_with_tax - tax_money
    print("the personal total income {},    income with tax {},     tax {},     income without tax {}".format(total_income, personal_income_with_tax, tax_money, personal_income_without_tax))
